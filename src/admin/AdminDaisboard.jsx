        ...
        <div>
            ...
            <div class=" w3-sidebar w3-light-grey w3-card w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left bg-[#86A7FC]" id="mySidebar">
                ...
                <div class="bg-[#86A7FC] w3-sidebar w3-bar-block  w3-card" style={{ width: "200px" }}>
                    <button  class="w3-bar-item w3-button w3-large w3-hide-large text-end " onClick={w3_close}>Close &times;</button>
                    <h1 className=' text-2xl  font-semibold flex items-center justify-center'><MdAdminPanelSettings/>Admin</h1>
                    <Link class="w3-bar-item w3-button" to=''>Link 1</Link>
